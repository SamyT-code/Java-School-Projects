...
public class Game {
  ...
  static boolean play() {
      ...
      */    
      ...
      /*  First the user gets a chance to draw cards ("Hit").  The while loop ends 
     ...
     while (true) {
           ...
           /* If the user Hits, the user gets a card.  If the user Stands,
              the loop ends (and it's the computer's turn to draw cards).
           */
           if ( userAction == 'S' ) {
      ...
      /* If we get to this point, the user has Stood with 21 or less.  Now, it's
         the computer's chance to draw. Computer draws cards until the computer's
         total is > 16.  If computer goes over 21, the computer looses.
      */
