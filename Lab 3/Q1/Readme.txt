...
2. From that folder, compile and run TestL2.java:
Under macOS, Linux, or Unix in general:
> javac -cp junit-4.13.jar:hamcrest-core-1.3.jar:. TestReplace.java

> java -cp junit-4.13.jar:hamcrest-core-1.3.jar:. TestReplace
