public class TestBook{
	...
	public static void main(String [] args){
		...
		System.out.println("Total book prices recorded by first accountant (b1 + b3): " + a1.getTotalPrice());
		System.out.println("Total book prices recorded by second accountant (b2): " + a2.getTotalPrice());

		System.out.println();

		System.out.println("total book prices recorded by accountant is: $" + b1.getAccountant().getTotalPrice());
	}
}
